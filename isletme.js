...
async function loadBusiness() {
    ...
    if (!slug) {
        container.innerHTML = `
            <div class="error">
                ...
                <p>Geçerli bir işletme adresi belirtilmemiş.</p>
            </div>
        `;
        return;
    }
    ...
    if (error) {
        ...
        container.innerHTML = `
            <div class="error">
                ...
                <p>İşletme bilgileri alınamadı.</p>
            </div>
        `;
    ...
    if (!business) {
        container.innerHTML = `
            <div class="error">
                <h2>İşletme bulunamadı</h2>
                <p>Bu işletme yayında olmayabilir.</p>
            </div>
        `;
    ...
    if (business.instagram) {
        ...
        let instagramUrl = business.instagram.trim();
    ...
    container.innerHTML = `
        <article class="business-detail-card">
            ...
            <img
                ...
                onerror="this.src='https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&fit=crop&w=1400&q=80'"
            >
